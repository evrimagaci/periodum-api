...
type Resolver = (data: Record<string, unknown>) => Record<string, unknown> | Record<string, unknown>[];
...
export default function getNecessaryData(raw: PubChemCompound): PubChemCompound {
